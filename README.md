...
## MUSIC Algorithm
Like Pisarenko's method, the MUSIC algorithm is a frequency estimation technique. MUSIC method divide the eigenvalues of the correlation matirx $\mathbf{R_x}$ (size: _M_ X _M_) into two groups: the p signal eigenvectors corresponding to the p largest eigenvalues, 
